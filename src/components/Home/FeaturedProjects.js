                ...
                <div className=''>
                    <div class="flex flex-col lg:flex-row bg-secondary h-[380px] items-start lg:items-center">
                        ...
                        <div class="w-full lg:w-[40%] mt-6 lg:mt-0 text-left lg:text-right">
                            ...
                            <p className='py-3 text-info'>Carpentryz is a website built focusing on product manufacturers. Both buyers and sellers can use this website.</p>
                            ...
                            <div className='mt-5'>
                                <a href="https://github.com/thowhidulislam/carpentryz-client-side" target='_blank' rel='noreferrer' className=' inline-block my-1 mr-3 text-info focus:bg-transparent hover:text-primary font-bold'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github"><title>Github</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg></a>
                                <Link to='/carpentryzDetails' className='inline-block my-1 mr-3 text-info focus:bg-transparent hover:text-primary font-bold' title='More Details'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info"><circle cx="12" cy="12" r="10"><title>More Details</title></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                                </Link>
                                <a href="https://carpentryz.web.app/" className='inline-block my-1 text-info focus:bg-transparent hover:text-primary font-bold' target='_blank' rel='noreferrer' >
                    ...
                    <div class="flex flex-col lg:flex-row-reverse bg-secondary h-[380px] items-start lg:items-center my-40 lg:my-24">
                        ...
                        <div class="w-full lg:w-[40%] mt-6 lg:mt-0 text-left">
                            ...
                            <p className='py-3 text-info'>SpiceKart is a warehouse management website.</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <Link to="/spiceKartDetails" className='text-end inline-block my-1 mr-3 text-info focus:bg-transparent hover:text-primary font-bold' title='More Details'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info"><circle cx="12" cy="12" r="10"><title>More Details</title></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                                </Link>
                    ...
                    <div class="flex flex-col lg:flex-row bg-secondary h-[380px] items-start lg:items-center my-40 lg:my-24">
                        ...
                        <div class="w-full lg:w-[40%] text-left lg:text-right mt-6 lg:mt-0">
                            ...
                            <p className='py-3 text-info'>It is an independent service provider website.</p>
                            <p className='text-info text-sm font-bold'><small><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>React</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>Express</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>Bootstrap</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>React Hook Form</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>React Firebase Hooks</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>Recharts</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>Axios</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>Heroku</span><span className='mr-2 rounded px-1 py-0.5 my-0.5 bg-neutral inline-block'>MongoDB</span></small></p>
                            <div className='mt-5'>
                                ...
                                <Link to="/reynoldsDetails" className='text-end inline-block my-1 mr-3 text-info focus:bg-transparent hover:text-primary font-bold' title='More Details'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info"><circle cx="12" cy="12" r="10"><title>More Details</title></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                                </Link>
