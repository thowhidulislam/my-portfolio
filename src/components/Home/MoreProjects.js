        ...
        <div className='flex flex-col lg:flex-row gap-y-2 lg:gap-x-2 mb-20'>
            ...
            <div class="card w-96 bg-base-100 shadow-xl image-full">
                ...
                <div class="card-body">
                    ...
                    <p>It is a product selling website where buyers can give reviews after buying products. Reviews section on the home shows only three reviews.</p>
            ...
            <div class="card w-96 bg-base-100 shadow-xl image-full">
                ...
                <div class="card-body">
                    ...
                    <p>User can search phones and see details of that particular phones.</p>
                    <div className='flex flex-row gap-x-3'>
            ...
            <div class="card w-96 bg-base-100 shadow-xl image-full">
                ...
                <div class="card-body">
                    ...
                    <p>System will randomly choose one headset from four headsets user selected from the website.</p>
                    <div className='flex flex-row gap-x-3'>
