    ...
    return (
        <section className='bg-secondary text-white mx-4 px-4 lg:mx-20 lg:px-10 pb-14'>
            ...
            <div className='text-info'>
                <p className='text-info my-5 lg:my-12'>Carpentryz is a website built focusing on product manufacturers. Both buyers and sellers can use this website.</p>
                <ul className='my-8'>
